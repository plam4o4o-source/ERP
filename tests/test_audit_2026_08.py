...
Забележка (25.08.2026): К1 (pull_db от GitHub) отпадна заедно с премахнатата
GitHub синхронизация — тестовият файл test_backup_sync.py вече не съществува.
Локалното архивиране е покрито в test_backup_local.py."""
import io
import json
import os
import re
