...
Засега защитава само GitHub Personal Access Token-а (`gh_token`) — единствената
истинска тайна в този файл (виж config.py: всичко останало там е bootstrap
настройка, нужна преди базата данни да съществува, не тайна сама по себе си).
